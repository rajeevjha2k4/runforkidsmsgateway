...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("runforkidsmsgateway");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("runforkidsmsgateway");
        ...
        config.getMapConfigs().put("com.dbs.sg.rfk.gateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
